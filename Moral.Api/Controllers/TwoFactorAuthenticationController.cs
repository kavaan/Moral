...
namespace Moral.Api.Controllers
{
    ...
    public class TwoFactorAuthenticationController : Controller
    {
        ...
        [HttpGet]
        [Authorize]
        public async Task<AccountDetailsDto> Details()
        {
        ...
        [HttpGet]
        [Authorize]
        public async Task<AuthenticatorDetailsDto> SetupAuthenticator()
        {
            var user = await _userManager.GetUserAsync(User);
        ...
        [HttpPost]
        [Authorize]
        public async Task<ResultDto> VerifyAuthenticator([FromBody] VefiryAuthenticatorDto verifyAuthenticator)
        {
            var user = await _userManager.GetUserAsync(User);
        ...
        [HttpPost]
        [Authorize]
        public async Task<ResultDto> ResetAuthenticator()
        {
            var user = await _userManager.GetUserAsync(User);
        ...
        [HttpPost]
        [Authorize]
        public async Task<ResultDto> Disable2FA()
        {
            var user = await _userManager.GetUserAsync(User);
        ...
        [HttpPost]
        [Authorize]
        public async Task<ResultDto> GenerateRecoveryCodes()
        {
            var user = await _userManager.GetUserAsync(User);
        ...
        [HttpPost]
        public async Task<ResultDto> Login([FromBody] TwoFactorLoginDto model)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        public async Task<ResultDto> LoginWithRecovery([FromBody] TwoFactorRecoveryCodeLoginDto model)
        {
            if (ModelState.IsValid)
            {
        ...
        private async Task<AuthenticatorDetailsDto> GetAuthenticatorDetailsAsync(IdentityUser user)
        {
